...
<h1 class="text-center text-2xl font-bold text-gray-800">投稿一覧</h1>
</div>
  ...
  <div class="mx-auto grid max-w-6xl  grid-cols-1 gap-6 p-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
    ...
    <article class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 ">
      <a href="/sneakers/{{ $sneaker->id }}">
        <div class="relative flex items-end overflow-hidden rounded-xl h-60 w-60">
        ...
        <div class="mt-1 p-2">
          ...
          <div class="mt-3 flex items-end justify-between">
            ...
            <form action="/sneakers/{{ $sneaker->id }}" id="form_{{ $sneaker->id }}" method="post">
                @csrf
                @method('DELETE')
              <button class="text-sm" onclick="deleteSneaker({{ $sneaker->id }})">delete</button>
            </form>
            </div>
          </div>
        </div>
	...
	<div class="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
		<div class="grid justify-center  lg:justify-between">
			...
			<div class="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
				<a rel="noopener noreferrer" href="mailto:r202004396io@jindai.jp" title="Email" class="flex items-center justify-center w-10 h-10 rounded-full bg-blue-500 hover:bg-blue-600 duration-150 text-gray-50">
				...
				<a rel="noopener noreferrer" href="https://github.com/oldriver0801/sneaker" title="GitHub" class="flex items-center justify-center w-10 h-10 rounded-full bg-blue-500 hover:bg-blue-600 duration-150 text-gray-50">
